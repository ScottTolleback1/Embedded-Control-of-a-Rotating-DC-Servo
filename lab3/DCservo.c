...
#define K_fixed  (int16_t)(K  * (1 << 13))  
#define Ti_fixed (int16_t)(Ti * (1 << 13))  
#define B_fixed  (int16_t)(B  * (1 << 13)) 
#define h_fixed  (int16_t)(h  * (1 << 13)) 
#define KB_fixed (int16_t)(KB * (1 << 13)) 
#define k1_fixed (int16_t)(k1 * (1 << 13)) 
#define k2_fixed (int16_t)(k2 * (1 << 13)) 
